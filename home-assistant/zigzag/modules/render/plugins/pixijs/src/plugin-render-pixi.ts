...
type PluginConfigRenderPixi = PluginConfigRender;
/**
...
export class RenderPlugin extends PluginRenderBase {
  ...
  public readonly config: PluginConfigRenderPixi;
  ...
  constructor(config: PluginConfigRenderPixi) {
    super();
...
export function createPlugin(config: PluginConfigRenderPixi): RenderPlugin {
